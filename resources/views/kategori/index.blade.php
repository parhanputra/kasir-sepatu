                ...
                <div class="card shadow">
                    <div class="card-header bg-primary">
                        ...
                        <div class="card-header-form float-right">
                            <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#form-tambah"><i class="fa fa-plus"></i> Tambah</button>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="/kategori/{{$item->id}}" id="delete-form">
                                            <a href="/kategori/{{$item->id}}/edit" class="btn btn-sm btn-outline-warning"><i
